        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 text-center">
              <div className="text-2xl font-bold mb-1" style={{ color: "#0057A8" }}>Free</div>
              <div className="text-sm text-gray-500">PERM (DOL) Filing</div>
            </div>
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 text-center">
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 text-center">
              ...
              <div className="text-sm text-gray-500">I-485 Adjustment of Status</div>
            </div>
          </div>
          <p className="text-xs text-gray-400 mt-4">Fees subject to change — verify at uscis.gov before filing. Priority date wait times vary significantly by country of birth.</p>
        </div>
      </section>
