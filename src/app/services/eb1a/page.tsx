        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 text-center">
              <div className="text-2xl font-bold mb-1" style={{ color: "#0057A8" }}>$1,015</div>
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 text-center">
              <div className="text-2xl font-bold mb-1" style={{ color: "#0057A8" }}>4–9 Months</div>
              <div className="text-sm text-gray-500">Standard Processing Time</div>
            </div>
          </div>
          <p className="text-xs text-gray-400 mt-4">Note: Premium processing (15 business days) is available for I-140. Fees subject to change — verify at uscis.gov before filing.</p>
        </div>
      </section>
