...
export default function EB5Page() {
  return (
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-8" style={{ color: "#1a1a2e" }}>Investment Amounts & Fees</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 border border-gray-100 text-center">
              <div className="text-2xl font-bold mb-1" style={{ color: "#0057A8" }}>$1,050,000</div>
              <div className="text-sm text-gray-500">Standard Investment Amount</div>
            </div>
            <div className="bg-white rounded-xl p-6 border border-gray-100 text-center">
              <div className="text-2xl font-bold mb-1" style={{ color: "#0057A8" }}>$800,000</div>
              <div className="text-sm text-gray-500">TEA (Targeted Employment Area) Investment</div>
            </div>
            <div className="bg-white rounded-xl p-6 border border-gray-100 text-center">
              <div className="text-2xl font-bold mb-1" style={{ color: "#0057A8" }}>$1,440</div>
              <div className="text-sm text-gray-500">I-485 Filing Fee</div>
            </div>
          </div>
          <p className="text-xs text-gray-400 mt-4">I-526/I-526E filing fees — verify current amounts at uscis.gov. Investment amounts set by regulation and subject to periodic adjustment.</p>
        </div>
      </section>
