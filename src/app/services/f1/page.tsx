...
export default function F1Page() {
  return (
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-8" style={{ color: "#1a1a2e" }}>Fees & Work Authorization</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 text-center">
              <div className="text-2xl font-bold mb-1" style={{ color: "#0057A8" }}>$350</div>
              <div className="text-sm text-gray-500">SEVIS I-901 Fee</div>
            </div>
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-100 text-center">
              <div className="text-2xl font-bold mb-1" style={{ color: "#0057A8" }}>$185</div>
              <div className="text-sm text-gray-500">MRV Visa Application Fee</div>
            </div>
          </div>
          <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
            <h3 className="font-bold text-blue-900 mb-3">Work Authorization Options</h3>
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: "#0057A8" }} />
                <p className="text-sm text-blue-800"><strong>OPT (Optional Practical Training):</strong> 12 months of work authorization after graduation; STEM graduates may apply for 24-month extension (total 36 months).</p>
              </div>
              <div className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: "#0057A8" }} />
                <p className="text-sm text-blue-800"><strong>CPT (Curricular Practical Training):</strong> Internship work authorization during studies when the practical training is an integral part of the curriculum.</p>
              </div>
            </div>
          </div>
          <div className="mt-4 p-4 bg-yellow-50 rounded-xl border border-yellow-200">
            <p className="text-sm text-yellow-800"><strong>Note:</strong> The F-1 is a nonimmigrant visa. However, F-1 holders may transition to immigrant categories (e.g., H-1B, EB-2/EB-3) after graduation.</p>
          </div>
        </div>
      </section>
