    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <p>Email info@theviservegroup.com with your case number, denial notice, and a description of the error. We will review and respond within 5 business days.</p>
        </section>
      </div>
    </div>
  );
