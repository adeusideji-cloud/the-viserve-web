...
export const metadata: Metadata = {
  ...
  description: "The ViServe provides expert immigration guidance, visa processing support, and document preparation services for individuals and families worldwide.",
