    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Access your immigration dashboard</p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                ...
                <Link href="/portal/forgot-password" className="text-xs text-blue-600 hover:underline">Forgot password?</Link>
              </div>
          ...
          <div className="mt-6 pt-5 border-t border-gray-100 text-center space-y-2">
            <p className="text-sm text-gray-500">New to The ViServe?{" "}
              <Link href="/register" className="font-semibold text-blue-600 hover:underline">Create free account</Link>
            </p>
